...
<div class="py-6">
    ...
    <h2 class="text-3xl font-bold page-title mb-6">Editar Ordem de Serviço - {{ $ordem->numero_ordem }}</h2>
    
    <div class="glass-card rounded-2xl p-6">
        <form method="POST" action="{{ route('ordensservico.update', $ordem) }}" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" value="{{ $ordem->cliente->nome }}" disabled class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100">
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-900 mb-2">Aparelho *</label>
                    <input type="text" name="aparelho" value="{{ old('aparelho', $ordem->aparelho) }}" placeholder="Ex: Notebook, Desktop..." 
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="defeito_relatado" rows="4" placeholder="Descreva o defeito relatado pelo cliente..."
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 @error('defeito_relatado') border-red-500 @enderror">{{ old('defeito_relatado', $ordem->defeito_relatado) }}</textarea>
                ...
                <div>
                    ...
                    <select name="status" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 @error('status') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <select name="tecnico_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 @error('tecnico_id') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="orcamento" step="0.01" value="{{ old('orcamento', $ordem->orcamento) }}" placeholder="0.00"
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-2.5 text-gray-500">R$</span>
                        <input type="number" name="valor_aprovado" step="0.01" value="{{ old('valor_aprovado', $ordem->valor_aprovado) }}" placeholder="0.00"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="observacoes" rows="3" placeholder="Observações adicionais..."
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 @error('observacoes') border-red-500 @enderror">{{ old('observacoes', $ordem->observacoes) }}</textarea>
