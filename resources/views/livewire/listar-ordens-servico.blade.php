<div class="bg-white rounded-lg shadow p-6">
    <form method="GET" action="{{ route('ordensservico.index') }}" class="mb-6 flex gap-4">
        ...
        <a href="{{ route('ordensservico.index') }}" class="px-4 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600">
            Limpar
        </a>
    </form>
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                <thead class="bg-gray-100 border-b">
                    <tr>
                        <th class="px-6 py-3 text-left text-sm font-medium text-gray-900">Número</th>
                        <th class="px-6 py-3 text-left text-sm font-medium text-gray-900">Cliente</th>
                        <th class="px-6 py-3 text-left text-sm font-medium text-gray-900">Aparelho</th>
                        <th class="px-6 py-3 text-left text-sm font-medium text-gray-900">Status</th>
                        <th class="px-6 py-3 text-left text-sm font-medium text-gray-900">Data Entrada</th>
                        <th class="px-6 py-3 text-left text-sm font-medium text-gray-900">Ações</th>
                    </tr>
                </thead>
