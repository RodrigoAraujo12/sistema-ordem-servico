...
<head>
    ...
    <title>@yield('title', 'Ordem de Serviço')</title>
    @livewireStyles
    ...
    <style>
        ...
        body.app-bg {
            background-image: url('{{ asset("images/identity-bg.png") }}');
    ...
    <div class="max-w-7xl mx-auto app-bg-overlay">
        @auth
            <div class="flex gap-4 my-6">
                <a href="{{ route('ordensservico.index') }}" class="px-4 py-2 bg-brand-accent text-white rounded-lg hover:bg-brand-accent-soft transition-colors shadow-md">Listar Ordens</a>
                ...
                @endif
                <a href="{{ route('clientes.index') }}" class="px-4 py-2 bg-brand-accent text-white rounded-lg hover:bg-brand-accent-soft transition-colors shadow-md">Clientes</a>
                @if(Auth::user()->isAdmin())
                <a href="{{ route('admin.dashboard') }}" class="px-4 py-2 bg-brand-border-strong text-white rounded-lg hover:bg-brand-accent-soft transition-colors shadow-md">Dashboard</a>
                @endif
            </div>
        @endauth
