...
<div class="py-6">
    ...
    <h2 class="text-3xl font-bold page-title mb-6">Editar Cliente - {{ $cliente->nome }}</h2>
        ...
        <form method="POST" action="{{ route('clientes.update', $cliente) }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="nome" value="{{ old('nome', $cliente->nome) }}" placeholder="Ex: João Silva" 
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email', $cliente->email) }}" placeholder="exemplo@email.com"
                ...
                <div>
                    ...
                    <input type="text" name="telefone" id="telefone" value="{{ old('telefone', $cliente->telefone) }}" placeholder="(11) 99999-9999" maxlength="15"
                ...
                <div>
                    ...
                    <input type="text" name="cpf" id="cpf" value="{{ old('cpf', $cliente->cpf) }}" placeholder="000.000.000-00" maxlength="14"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="endereco" rows="3" placeholder="Rua, número, bairro, cidade..." 
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 @error('endereco') border-red-500 @enderror">{{ old('endereco', $cliente->endereco) }}</textarea>
